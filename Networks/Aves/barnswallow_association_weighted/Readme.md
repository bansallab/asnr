...
Network Visualization | ![Network Image](/Networks/Visualization/final_barnswallow_levin_contact_network-1.png)* Barn swallow physcial contact network: the size of the node corresponds to its degree, and the color corresponds to its modularity class*
