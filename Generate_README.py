...
Interaction_defs = ["Physical contact occurs between individuals that are not grooming, trophallaxis, or dominance behaviors",
                    ...
                    "Multiple different types of interactions",
                    "Individuals were seen foraging together",
                    "Individuals were part of the same group as defined by the research study",
                    "Individuals share the same food source",
                    "Indiivduals observed engaging in mating with fluid excahnge",
                    "Individuals observed engaging in mating without fluid exhange",
                    "Direct interaction between individuals that does not involve physical contact (e.g. sniffing, chasing)",
                    "Active avoidance between two individuals"
                    ]    
...
with open("README.md", "a") as f:
    ...
    f.write("Average/Standard Deviation Degree: The average number and standard deviation in contacts for all nodes in the network. \n\n")
    ...
    f.write("Average/Standard Deviation Node Strength: The average and standard deviation of the sum of all the edgeweights connected to each node in the network. \n\n")
    ...
    f.write("Degree Assortativity: The tendency of contacts to have a similar number of contacts. Higher values mean high degree individuals form more bonds, lower values mean that high degree individuals form bonds with low degree individuals. \n\n")
    f.write("Average/Standard Deviation Betweenness Centrality (Weighted/Unweighted): The tendency for nodes to occupy a central position in the network. Higher values mean the network has more central or bridge nodes. Values calculated both with and without edge weights. \n\n")
    ...
    f.write("Clustering Coefficient (Weighted/Unweighted): The tendancy for a set of three individuals to be connected, or for an individual's contacts to interact with eachother. Calculated both with and without edgeweights. \n\n")
